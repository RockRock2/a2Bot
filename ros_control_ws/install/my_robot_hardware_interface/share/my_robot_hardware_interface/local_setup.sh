...
: ${AMENT_CURRENT_PREFIX:="/home/rockpi/ros_control_ws/install/my_robot_hardware_interface"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_robot_hardware_interface/environment/library_path.sh"
